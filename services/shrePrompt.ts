...
export const ELEMENT_ACCENT_DECOR: Record<Element, string> = {
  ...
  fire:  'FIRE lighting (a single brass library lamp with amber pleated shade pooling warm light at human-eye height, lit beeswax candles in brass holders, one warm-glow wall sconce, a small fireplace or candle hearth) + FIRE decor (a cognac leather cushion or bench detail, a small persian or kilim rug fragment, a brass tray with two glasses, an open cigar box or whisky bottle)',
